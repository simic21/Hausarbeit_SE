...
\begin{titlepage}
	...
	\begin{tabbing}
		...
		Betreuer: \> \> \myBetreuer\\
           \> \> Dozent im Fach Software Engineering\\
		\> \> \\
...
\pagenumbering{Roman}
\setcounter{page}{6}
\addcontentsline{toc}{section}{Interview vom 01.07.2017}
\input{kapitel/fazit/interview}
...
\printbibliography[type=patent,heading=subbibliography,title={Persönliche Mitteilungen}]
